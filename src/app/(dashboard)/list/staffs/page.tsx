...
import { Room, Prisma, CareRoutine, Staff } from "@prisma/client";
import Image from "next/image";
import Link from "next/link";
import { ITEM_PER_PAGE } from "@/lib/settings";
import { auth } from "@clerk/nextjs/server";

type StaffList = Staff & { careRoutines: CareRoutine[] } & { rooms: Room[] };
...
const StaffListPage = async ({
  ...
  const columns = [
    ...
    {
      header: "Care Routines",
      accessor: "careRoutines",
      className: "hidden md:table-cell",
    },
    {
      header: "Rooms",
  ...
  const renderRow = (item: StaffList) => (
    ...
    >
      ...
      {/* <td className="hidden md:table-cell">
        {item.careRoutines.map((routine) => routine.name).join(",")}
      </td>
      <td className="hidden md:table-cell">
